...
![Build-Status](https://github.com/drakilima/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
Der Account-Microservice soll die zentrale Verwaltung von Kundenkonten übernehmen. Dazu gehören insbesondere:

- Kundenkonten anlegen

- Einzelne Kundenkonten abrufen

- Kundenkonten aktualisieren

- Kundenkonten löschen

- Kundenkonten auflisten

Der Service ist als eigenständiger Mikroservice konzipiert. Dadurch bleibt die Kontoverwaltung von anderen Geschäftsprozessen der E-Commerce-Plattform getrennt und kann unabhängig weiterentwickelt und betrieben werden.
